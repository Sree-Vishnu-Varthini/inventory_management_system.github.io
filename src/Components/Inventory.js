            ...
            <div className="card" style={cardStyle}>
                <img src={Image1} className="card-img-top" alt="..."></img>
                    <div className="card-body"  style={{ backgroundColor:'#E1D89F', borderEndEndRadius:'6px',borderEndStartRadius:'6px'}}>
                        ...
                        <Link to="/Stationery" className="btn btn-primary" style={{ marginTop: '20px', backgroundColor:'#5e175b',border:'none'}}>View</Link>
                    </div>
            </div>
            ...
            <div className="card" style={cardStyle}>
                <img src={Image2} className="card-img-top" alt="..."></img>
                    <div className="card-body"  style={{ backgroundColor:'#E1D89F', borderEndEndRadius:'6px',borderEndStartRadius:'6px'}}>
                        ...
                        <Link to="/Electronics" className="btn btn-primary" style={{ marginTop: '20px', backgroundColor:'#5e175b',border:'none'}}>View</Link>
                    </div>
            </div>
            ...
            <div className="card" style={cardStyle}>
                <img src={Image3} className="card-img-top" alt="..."></img>
                    <div className="card-body" style={{ backgroundColor:'#E1D89F', borderEndEndRadius:'6px',borderEndStartRadius:'6px'}}>
                        ...
                        <Link to="/Footwear" className="btn btn-primary" style={{ marginTop: '20px', backgroundColor:'#5e175b',border:'none'}}>View</Link>
                    </div>
            </div>
        </div>
